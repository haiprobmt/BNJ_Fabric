...
ETL_LOG_TABLE = "`{WORKSPACE_NAME}`.lh_bnj_metadata.md.etl_log"   # change to your full table name if needed
LOG_SOURCE    = "FABRIC"
...
def start_job_instance(batch_id: str, job_id: str, msg: str = None):
    etl_log_upsert(batch_id, job_id, "RUNNING", msg, set_start=True, set_end=False)

def start_job_instance_dev(batch_id: str, job_id: str, batch_group: str, job_group_name: str):
    #etl_log_upsert(batch_id, job_id, "RUNNING", msg, set_start=True, set_end=False)
